            ...
            {viewApplicationsPageData.map((applicant, i) => (
              <tr key={i} className='text-gray-700 hover:bg-gray-50'>
                ...
                <td className='py-2 px-4 border-b'>
                  <a href="" target='_blank' className='bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex items-center gap-2'>Resume <img src={assets.resume_download_icon} alt="" /></a>
                </td>
